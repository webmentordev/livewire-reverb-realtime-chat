            ...
            <div class="p-6 text-gray-900">
                ...
                <form class="mt-3">
                    ...
                    <textarea name="body" id="body" cols="30" rows="4"
                        ...
                        x-on:keyup.shift="shift = false" x-on:keydown.enter="if(!shift || !$event.target.value) { $event.preventDefault() }"
                        ...
                        typingTimeout = setTimeout(handleTypingFinished, 3000)"></textarea>
